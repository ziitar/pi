...
export function clampReasoning(effort: ThinkingLevel | undefined): Exclude<ThinkingLevel, "off" | "xhigh"> | undefined {
	return effort === "xhigh" ? "high" : effort === "off" ? undefined : effort;
}
